!(function (e, t) {
            ...
            for ("boolean" == typeof s && ((l = s), (s = arguments[a] || {}), a++), "object" == typeof s || h.isFunction(s) || (s = {}), a === u && ((s = this), a--); u > a; a++)
                if (null != (e = arguments[a]))
                    for (t in e)
                        (n = s[t]),
                            s !== (r = e[t]) &&
                            (l && r && (h.isPlainObject(r) || (i = h.isArray(r))) ? (i ? ((i = !1), (o = n && h.isArray(n) ? n : [])) : (o = n && h.isPlainObject(n) ? n : {}), (s[t] = h.extend(l, o, r))) : void 0 !== r && (s[t] = r));
            return s;
        }),
        h.extend({
                    ...
                    ? ((f = i),
                        ...
                        (oe(function (e) {
                            (e.innerHTML = "<select t=''><option selected=''></option></select>"),
                                e.querySelectorAll("[t^='']").length && h.push("[*^$]=" + P + "*(?:''|\"\")"),
                                e.querySelectorAll("[selected]").length || h.push("\\[" + P + "*(?:value|" + F + ")"),
                            ...
                            oe(function (e) {
                                ...
                                t.setAttribute("type", "hidden"),
                                    ...
                                    e.querySelectorAll("[name=d]").length && h.push("name" + P + "*[*^$|!~]?="),
                                    e.querySelectorAll(":enabled").length || h.push(":enabled", ":disabled"),
                                    e.querySelectorAll("*,:x"),
                                    h.push(",.*:");
                            })),
                        (n.matchesSelector = Q.test((m = p.webkitMatchesSelector || p.mozMatchesSelector || p.oMatchesSelector || p.msMatchesSelector))) &&
                        oe(function (e) {
                ...
                preFilter: {
                    ...
                    PSEUDO: function (e) {
                        ...
                        return V.CHILD.test(e[0])
                            ? null
                            : (e[3] && void 0 !== e[4] ? (e[2] = e[4]) : n && z.test(n) && (t = de(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                    },
                },
                filter: {
                    TAG: function (e) {
                        ...
                        return 1 === r && 0 === i
                            ...
                            : function (t, n, u) {
                                ...
                                if (m) {
                                    ...
                                    else for (; (f = (++d && f && f[g]) || (p = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++p || (x && ((f[y] || (f[y] = {}))[e] = [b, p]), f !== t)););
        ...
        function de(e, t) {
            ...
            for (a = e, u = [], l = r.preFilter; a;) {
                for (s in ((!n || (i = I.exec(a))) && (i && (a = a.slice(i[0].length) || a), u.push((o = []))),
                    (n = !1),
                    (i = _.exec(a)) && ((n = i.shift()), o.push({ value: n, type: i[0].replace(B, " ") }), (a = a.slice(n.length))),
                    r.filter))
            ...
            return (
                ...
                ie(function (o, s, a, u) {
                    var l,
                        ...
                        v = n ? (i || (o ? e : h || r) ? [] : s) : m;
                    if ((n && n(m, v, a, u), r)) for (l = ve(v, d), r(l, [], a, u), c = l.length; c--;) (f = l[c]) && (v[d[c]] = !(m[d[c]] = f));
                    if (o) {
                        if (i || e) {
                            if (i) {
            ...
            for (
                ...
                if ((n = r.relative[e[l].type])) p = [ge(me(p), n)];
                    ...
                    if ((n = r.filter[e[l].type].apply(null, e[l].matches))[y]) {
                        ...
                        return ye(l > 1 && me(p), l > 1 && he(e.slice(0, l - 1).concat({ value: " " === e[l - 2].type ? "*" : "" })).replace(B, "$1"), n, i > l && xe(e.slice(l, i)), o > i && xe((e = e.slice(i))), o > i && he(e));
                    }
                    p.push(n);
                }
            return me(p);
    ...
    (h.Callbacks = function (e) {
                ...
                remove: function () {
                    return (
                        ...
                        h.each(arguments, function (e, t) {
                            for (var n; (n = h.inArray(t, a, n)) > -1;) a.splice(n, 1), r && (o >= n && o--, s >= n && s--);
                        }),
                        this
                    );
                },
        ...
        h.extend({
            ...
            when: function (e) {
                ...
                if (a > 1) for (t = new Array(a), n = new Array(a), i = new Array(a); a > o; o++) s[o] && h.isFunction(s[o].promise) ? s[o].promise().done(c(o, i, s)).fail(l.reject).progress(c(o, n, t)) : --u;
    ...
    var H = (h.access = function (e, t, n, r, i, o, s) {
        var a = 0,
            u = e.length,
            l = null == n;
        if ("object" === h.type(n)) for (a in ((i = !0), n)) h.access(e, t, a, n[a], !0, o, s);
        else if (
            void 0 !== r &&
            ((i = !0),
                h.isFunction(r) || (s = !0),
    ...
    (h.event = {
                ...
                for (
                    ...
                    (d = m = (a = Y.exec(t[l]) || [])[1]),
                        ...
                        ((f = h.event.special[d] || {}),
                            ...
                            (f = h.event.special[d] || {}),
                            (c = h.extend({ type: d, origType: m, data: r, handler: n, guid: n.guid, selector: i, needsContext: i && h.expr.match.needsContext.test(i), namespace: g.join(".") }, o)),
                            (p = u[d]) || (((p = u[d] = []).delegateCount = 0), (f.setup && !1 !== f.setup.call(e, r, g, s)) || (e.addEventListener && e.addEventListener(d, s, !1))),
        ...
        trigger: function (t, n, r, i) {
            ...
            if (
                ((s = a = r = r || p),
                    ...
                    (m.indexOf(".") >= 0 && ((v = m.split(".")), (m = v.shift()), v.sort()),
                        (c = m.indexOf(":") < 0 && "on" + m),
                        ((t = t[h.expando] ? t : new h.Event(m, "object" == typeof t && t)).isTrigger = i ? 2 : 3),
                        (t.namespace = v.join(".")),
                ...
                for (o = 0; (s = g[o++]) && !t.isPropagationStopped();)
                    (t.type = o > 1 ? u : d.bindType || m),
                        (f = (F.get(s, "events") || {})[t.type] && F.get(s, "handle")) && f.apply(s, n),
                        (f = c && s[c]) && f.apply && h.acceptData(s) && ((t.result = f.apply(s, n)), !1 === t.result && t.preventDefault());
                return (
                    (t.type = m),
                    i ||
                    ...
                    !h.acceptData(r) ||
                    (c && h.isFunction(r[m]) && !h.isWindow(r) && ((a = r[c]) && (r[c] = null), (h.event.triggered = m), r[m](), (h.event.triggered = void 0), a && (r[c] = a))),
                    t.result
                );
            }
        },
                ...
                for (a = h.event.handlers.call(this, e, l), t = 0; (o = a[t++]) && !e.isPropagationStopped();)
                    for (e.currentTarget = o.elem, n = 0; (s = o.handlers[n++]) && !e.isImmediatePropagationStopped();)
                        (!e.namespace_re || e.namespace_re.test(s.namespace)) &&
                            ((e.handleObj = s), (e.data = s.data), void 0 !== (i = ((h.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, u)) && !1 === (e.result = i) && (e.preventDefault(), e.stopPropagation()));
        ...
        (h.Event = function (e, t) {
            return this instanceof h.Event
                ? (e && e.type ? ((this.originalEvent = e), (this.type = e.type), (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && e.getPreventDefault && e.getPreventDefault()) ? G : Q)) : (this.type = e),
                    t && h.extend(this, t),
    ...
    function fe(e, t) {
        var n, r, i, o, s, a, u, l;
        if (1 === t.nodeType) {
            if (F.hasData(e) && ((o = F.access(e)), (s = F.set(t, o)), (l = o.events))) for (i in (delete s.handle, (s.events = {}), l)) for (n = 0, r = l[i].length; r > n; n++) h.event.add(t, i, l[i][n]);
    ...
    (se.optgroup = se.option),
        ...
        h.extend({
            clone: function (e, t, n) {
                ...
                if (!(f.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || h.isXMLDoc(e))) for (s = pe(a), r = 0, i = (o = pe(e)).length; i > r; r++) de(o[r], s[r]);
                if (t)
                    if (n) for (o = o || pe(e), s = s || pe(a), r = 0, i = o.length; i > r; r++) fe(o[r], s[r]);
                    else fe(e, a);
            ...
            buildFragment: function (e, t, n, r) {
                ...
                for (c.textContent = "", p = 0; (i = f[p++]);)
                    if ((!r || -1 === h.inArray(i, r)) && ((u = h.contains(i.ownerDocument, i)), (o = pe(c.appendChild(i), "script")), u && ce(o), n)) for (l = 0; (i = o[l++]);) re.test(i.type || "") && n.push(i);
                return c;
            },
            cleanData: function (e) {
                for (var t, n, r, i, o, s, a = h.event.special, u = 0; void 0 !== (n = e[u]); u++) {
                    if (h.acceptData(n) && (o = n[F.expando]) && (t = F.cache[o])) {
                        if ((r = Object.keys(t.events || {})).length) for (s = 0; void 0 !== (i = r[s]); s++) a[i] ? h.event.remove(n, i) : h.removeEvent(n, i, t.handle);
    ...
    function ve(e) {
        var t = p,
            n = ge[e];
        return (
            n || (("none" !== (n = me(e, t)) && n) || ((t = (he = (he || h("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentDocument).write(), t.close(), (n = me(e, t)), he.detach()), (ge[e] = n)), n
        );
    }
    var ye = /^margin/,
    ...
    function we(e, t, n) {
        ...
        return (
            ...
            ("" !== s || h.contains(e.ownerDocument, e) || (s = h.style(e, t)),
                xe.test(s) && ye.test(t) && ((r = a.width), (i = a.minWidth), (o = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = r), (a.minWidth = i), (a.maxWidth = o))),
            void 0 !== s ? s + "" : s
        );
    }
    function Te(e, t) {
        ...
        (o.style.backgroundClip = "content-box"),
            ...
            h.extend(f, {
                ...
                reliableMarginRight: function () {
                    ...
                    return (
                        (n.style.cssText = o.style.cssText = "padding:0;margin:0;border:0;display:block;-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box"),
    ...
    function Se(e, t) {
        if (t in e) return t;
        for (var n = t[0].toUpperCase() + t.slice(1), r = t, i = je.length; i--;) if ((t = je[i] + n) in e) return t;
        return r;
    }
    function Ae(e, t, n) {
        var r = Ne.exec(t);
    ...
    function Le(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2)
            "margin" === n && (s += h.css(e, n + B[o], !0, i)),
                r
                    ? ("content" === n && (s -= h.css(e, "padding" + B[o], !0, i)), "margin" !== n && (s -= h.css(e, "border" + B[o] + "Width", !0, i)))
                    : ((s += h.css(e, "padding" + B[o], !0, i)), "padding" !== n && (s += h.css(e, "border" + B[o] + "Width", !0, i)));
        return s;
    }
    function qe(e, t, n) {
        var r = !0,
        ...
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)
            (r = e[s]).style &&
                ((o[s] = F.get(r, "olddisplay")),
                    (n = r.style.display),
                    t
                        ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && I(r) && (o[s] = F.access(r, "olddisplay", ve(r.nodeName))))
                        : o[s] || ((i = I(r)), ((n && "none" !== n) || !i) && F.set(r, "olddisplay", i ? n : h.css(r, "display"))));
    ...
    h.extend({
                ...
                return (
                    ...
                    void 0 === n
                        ? s && "get" in s && void 0 !== (i = s.get(e, !1, r))
                            ? i
                            : u[t]
                        : ("string" === (o = typeof n) && (i = ke.exec(n)) && ((n = (i[1] + 1) * i[2] + parseFloat(h.css(e, t))), (o = "number")),
                            void (
                                null != n &&
                                n == n &&
        ...
        css: function (e, t, n, r) {
            ...
            return (
                ...
                (s = h.cssHooks[t] || h.cssHooks[a]) && "get" in s && (i = s.get(e, !0, n)),
                void 0 === i && (i = we(e, t, r)),
                "normal" === i && t in De && (i = De[t]),
                "" === n || n ? ((o = parseFloat(i)), !0 === n || h.isNumeric(o) ? o || 0 : i) : i
            );
        },
    }),
        ...
        (h.cssHooks.marginRight = Te(f.reliableMarginRight, function (e, t) {
            return t ? h.swap(e, { display: "inline-block" }, we, [e, "marginRight"]) : void 0;
        })),
        ...
        (Oe.prototype = {
            ...
            run: function (e) {
                ...
                return (
                    (this.pos = t = this.options.duration ? h.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e),
        ...
        $e = [
            function (e, t, n) {
                ...
                for (r in (n.queue ||
                    ...
                    ((n.overflow = [p.overflow, p.overflowX, p.overflowY]), "none" === (l = h.css(e, "display")) && (l = ve(e.nodeName)), "inline" === l && "none" === h.css(e, "float") && (p.display = "inline-block")),
                    n.overflow &&
                    ((p.overflow = "hidden"),
                        c.always(function () {
                ...
                if (!h.isEmptyObject(f))
                    for (r in (g ? "hidden" in g && (d = g.hidden) : (g = F.access(e, "fxshow", {})),
                        o && (g.hidden = !d),
                        d
                            ? h(e).show()
                            : c.done(function () {
    ...
    function Xe(e, t, n) {
        for (var r, i = (Be[t] || []).concat(Be["*"]), o = 0, s = i.length; s > o; o++) if ((r = i[o].call(n, t, e))) return r;
    }
    function ze(e, t, n) {
        var r,
            i,
    ...
    (h.Animation = h.extend(ze, {
        ...
        h.each({ slideDown: _e("show"), slideUp: _e("hide"), slideToggle: _e("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
        ...
        h.extend({
            attr: function (e, t, n) {
                ...
                if (e && 3 !== o && 8 !== o && 2 !== o)
                    return typeof e.getAttribute === X
                        ? h.prop(e, t, n)
                        : ((1 === o && h.isXMLDoc(e)) || ((t = t.toLowerCase()), (r = h.attrHooks[t] || (h.expr.match.bool.test(t) ? Ue : void 0))),
                            void 0 === n
            ...
            removeAttr: function (e, t) {
                var n,
                    ...
                    i = 0,
                    o = t && t.match(A);
                if (o && 1 === e.nodeType) for (; (n = o[i++]);) (r = h.propFix[n] || n), h.expr.match.bool.test(n) && (e[r] = !1), e.removeAttribute(n);
            },
            attrHooks: {
                type: {
                    set: function (e, t) {
    ...
    h.fn.extend({
        ...
        h.extend({
            ...
            prop: function (e, t, n) {
                ...
                if (e && 3 !== o && 8 !== o && 2 !== o)
                    return (
                        (1 !== o || !h.isXMLDoc(e)) && ((t = h.propFix[t] || t), (i = h.propHooks[t])),
    ...
    h.fn.extend({
            ...
            return "boolean" == typeof t && "string" === n
                ...
                : this.each(
                    h.isFunction(e)
                        ...
                        : function () {
                            if ("string" === n) for (var t, r = 0, i = h(this), o = e.match(A) || []; (t = o[r++]);) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
        ...
        hasClass: function (e) {
            for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(Ge, " ").indexOf(t) >= 0) return !0;
            return !1;
        },
    });
    var Qe = /\r/g;
    h.fn.extend({
        val: function (e) {
            ...
            return arguments.length
                ...
                : i
                    ? (t = h.valHooks[i.type] || h.valHooks[i.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(i, "value"))
                        ? n
    ...
    function ct(e) {
        return function (t, n) {
            ...
            if (h.isFunction(n)) for (; (r = o[i++]);) "+" === r[0] ? ((r = r.slice(1) || "*"), (e[r] = e[r] || []).unshift(n)) : (e[r] = e[r] || []).push(n);
        };
    }
    function ft(e, t, n, r) {
        var i = {},
    ...
    (Ze = st.exec(et.toLowerCase()) || []),
        h.extend({
            ...
            ajaxSettings: {
                ...
                accepts: { "*": lt, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript" },
            ...
            ajax: function (e, t) {
                ...
                var n,
                    ...
                    w = {
                        ...
                        getResponseHeader: function (e) {
                            var t;
                            if (2 === x) {
                                if (!o) for (o = {}; (t = rt.exec(i));) o[t[1].toLowerCase()] = t[2];
                                t = o[e.toLowerCase()];
                            }
                ...
                if (
                    ((d.promise(w).complete = g.add),
                        (w.success = w.done),
                        (w.error = w.fail),
                        (c.url = ((e || c.url || et) + "").replace(tt, "").replace(ot, Ze[1] + "//")),
                        ...
                        (c.dataTypes = h
                            ...
                            .match(A) || [""]),
                        null == c.crossDomain &&
                        ((a = st.exec(c.url.toLowerCase())), (c.crossDomain = !(!a || (a[1] === Ze[1] && a[2] === Ze[2] && (a[3] || ("http:" === a[1] ? "80" : "443")) === (Ze[3] || ("http:" === Ze[1] ? "80" : "443")))))),
                        c.data && c.processData && "string" != typeof c.data && (c.data = h.param(c.data, c.traditional)),
                        ft(at, c, t, w),
                        2 === x)
                )
                    return w;
                for (l in ((u = c.global) && 0 == h.active++ && h.event.trigger("ajaxStart"),
                    (c.type = c.type.toUpperCase()),
                    (c.hasContent = !it.test(c.type)),
                    (r = c.url),
                    c.hasContent || (c.data && ((r = c.url += (Ke.test(r) ? "&" : "?") + c.data), delete c.data), !1 === c.cache && (c.url = nt.test(r) ? r.replace(nt, "$1_=" + Je++) : r + (Ke.test(r) ? "&" : "?") + "_=" + Je++)),
                    c.ifModified && (h.lastModified[r] && w.setRequestHeader("If-Modified-Since", h.lastModified[r]), h.etag[r] && w.setRequestHeader("If-None-Match", h.etag[r])),
                    ((c.data && c.hasContent && !1 !== c.contentType) || t.contentType) && w.setRequestHeader("Content-Type", c.contentType),
                    w.setRequestHeader("Accept", c.dataTypes[0] && c.accepts[c.dataTypes[0]] ? c.accepts[c.dataTypes[0]] + ("*" !== c.dataTypes[0] ? ", " + lt + "; q=0.01" : "") : c.accepts["*"]),
                    c.headers))
                ...
                function T(e, t, o, a) {
                    ...
                    2 !== x &&
                        ((x = 2),
                            ...
                            l
                                ? (c.ifModified && ((T = w.getResponseHeader("Last-Modified")) && (h.lastModified[r] = T), (T = w.getResponseHeader("etag")) && (h.etag[r] = T)),
                                    204 === e || "HEAD" === c.type ? (C = "nocontent") : 304 === e ? (C = "notmodified") : ((C = b.state), (v = b.data), (l = !(y = b.error))))
                            ...
                            g.fireWith(f, [w, C]),
                            u && (p.trigger("ajaxComplete", [w, c]), --h.active || h.event.trigger("ajaxStop")));
                }
                return w;
            },
        ...
        h.each(["get", "post"], function (e, t) {
            h[t] = function (e, n, r, i) {
                return h.isFunction(n) && ((i = i || r), (r = n), (n = void 0)), h.ajax({ url: e, type: t, dataType: i, data: n, success: r });
            };
        }),
                                    ...
                                    (delete bt[s],
                                        ...
                                        "abort" === e
                                            ...
                                            : "error" === e
                                                ...
                                                : r(wt[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? { text: o.responseText } : void 0, o.getAllResponseHeaders()));
                            };
                        }),
                            (o.onload = t()),
                            (o.onerror = t("error")),
        ...
        h.ajaxPrefilter("json jsonp", function (t, n, r) {
            ...
            return a || "jsonp" === t.dataTypes[0]
                ? ((i = t.jsonpCallback = h.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
                    a ? (t[a] = t[a].replace(Nt, "$1" + i)) : !1 !== t.jsonp && (t.url += (Ke.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
    ...
    (h.fn.load = function (e, t, n) {
        ...
        return (
            ...
            h.isFunction(t) ? ((n = t), (t = void 0)) : t && "object" == typeof t && (i = "POST"),
            s.length > 0 &&
            h
    ...
    (h.offset = {
        ...
        h.fn.extend({
            offset: function (e) {
                ...
                return o
                    ? ((t = o.documentElement),
                        h.contains(t, r) ? (typeof r.getBoundingClientRect !== X && (i = r.getBoundingClientRect()), (n = Dt(o)), { top: i.top + n.pageYOffset - t.clientTop, left: i.left + n.pageXOffset - t.clientLeft }) : i)
                    : void 0;
            },
            position: function () {
                if (this[0]) {
                    ...
                    return (
                        "fixed" === h.css(n, "position")
                            ...
                            : ((e = this.offsetParent()), (t = this.offset()), h.nodeName(e[0], "html") || (r = e.offset()), (r.top += h.css(e[0], "borderTopWidth", !0)), (r.left += h.css(e[0], "borderLeftWidth", !0))),
                        { top: t.top - r.top - h.css(n, "marginTop", !0), left: t.left - r.left - h.css(n, "marginLeft", !0) }
                    );
                }
            },
